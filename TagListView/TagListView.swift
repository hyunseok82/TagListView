...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var removeIconImage: UIImage? {
        didSet {
            for tagView in tagViews {
    ...
    @IBInspectable open dynamic var maxRow: UInt = UInt.max {
        didSet {
            rearrangeViews()
        }
    }
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.removeIconLineColor = removeIconLineColor
        tagView.removeIconImage = removeIconImage
        tagView.tagButton.addTarget(self, action: #selector(tagPressed(_:)), for: .touchUpInside)
    ...
    open func setTitle(_ title: String, at index: Int) {
        tagViews[index].tagButton.titleLabel?.text = title
    }
    ...
    // MARK: - Events
    func tagPressed(_ tagButton: TagButton!) {
